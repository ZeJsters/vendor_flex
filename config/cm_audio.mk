...
ALARM_PATH := vendor/flex/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/flex/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/flex/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/flex/prebuilt/common/media/audio/ui
